...
extern __attribute__((weak)) uint32_t   Image$$ARM_LIB_HEAP$$ZI$$Base[];
extern __attribute__((weak)) uint32_t   Image$$ARM_LIB_HEAP$$ZI$$Limit[];

// Heap here is considered starting after ZI ends to Stack start
extern uint32_t               Image$$ARM_LIB_STACK$$ZI$$Base[];
extern uint32_t               Image$$RW_IRAM1$$ZI$$Limit[];

extern "C" __attribute__((weak)) __value_in_regs struct __initial_stackheap _mbed_user_setup_stackheap(uint32_t R0, uint32_t R1, uint32_t R2, uint32_t R3)
{
...
extern "C" __attribute__((weak)) void __iar_system_Mtxinit(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_system_Mtxdst(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_system_Mtxlock(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_system_Mtxunlock(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_file_Mtxinit(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_file_Mtxdst(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_file_Mtxlock(__iar_Rmtx *mutex) {}
extern "C" __attribute__((weak)) void __iar_file_Mtxunlock(__iar_Rmtx *mutex) {}
#if defined(__IAR_SYSTEMS_ICC__ ) && (__VER__ >= 8000000)
#pragma section="__iar_tls$$DATA"
extern "C" __attribute__((weak)) void *__aeabi_read_tp(void)
{
...
struct _reent;
// Stub out locks when an rtos is not present
extern "C" __attribute__((weak)) void __rtos_malloc_lock(struct _reent *_r) {}
extern "C" __attribute__((weak)) void __rtos_malloc_unlock(struct _reent *_r) {}
extern "C" __attribute__((weak)) void __rtos_env_lock(struct _reent *_r) {}
extern "C" __attribute__((weak)) void __rtos_env_unlock(struct _reent *_r) {}
...
__attribute__((weak)) const ticker_info_t *us_ticker_get_info()
{
...
__attribute__((weak)) const ticker_info_t *lp_ticker_get_info()
{
    static const ticker_info_t info = {
        1000000,
        32
...
extern "C" __attribute__((weak)) long int _scanf_mbtowc(
    int ignored,
    FILE *p,
    ScanfReadRec *sr,
    int *charmap,
