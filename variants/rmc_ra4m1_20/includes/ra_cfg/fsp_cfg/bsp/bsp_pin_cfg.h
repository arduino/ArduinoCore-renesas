...
#define A0 			(BSP_IO_PORT_01_PIN_00)
#define A1 			(BSP_IO_PORT_01_PIN_01)
#define A2 			(BSP_IO_PORT_00_PIN_14)
#define A3 			(BSP_IO_PORT_00_PIN_02)
#define A4_SDA 		(BSP_IO_PORT_00_PIN_01)
#define A5_SCL 		(BSP_IO_PORT_00_PIN_00)
